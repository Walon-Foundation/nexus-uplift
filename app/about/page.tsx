          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <motion.div
                ...
                className="bg-white dark:bg-white/[0.05] rounded-xl border border-border border-l-4 border-l-primary shadow-sm p-8"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {values.map(({ icon: Icon, label, desc }) => (
              <div
                key={label}
                className="bg-white dark:bg-white/[0.05] rounded-xl border border-border p-6 shadow-sm hover:border-primary/40 transition-all duration-200"
              >
      ...
      <section className="py-20 bg-muted">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {team.map((member) => (
              <div key={member.name}>
                <div className="bg-white dark:bg-white/[0.05] rounded-xl border border-border p-6 shadow-sm hover:border-primary/40 transition-all duration-200">
