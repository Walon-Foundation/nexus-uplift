...
export function CTA() {
  ...
  return (
    <section className="py-16 sm:py-24 bg-[#0f2f2d] dark:bg-[#0a1f1e] relative overflow-hidden">
      {/* Dot grid */}
      <div
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_-10%,rgba(77,182,172,0.25),transparent)] pointer-events-none" />
      {/* Soft bottom fade */}
      <div className="absolute bottom-0 inset-x-0 h-32 bg-gradient-to-t from-[#0f2f2d]/60 dark:from-[#0a1f1e]/60 to-transparent pointer-events-none" />
